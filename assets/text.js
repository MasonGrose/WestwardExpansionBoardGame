var data = [
    ["Get the plague, loose 15 tiles", 0.2, -15],
    ["Get the plague, loose 10 tiles", 0.2, -10],
    ["Move 2 tiles.", 6, 2],
    ["Move 3 tiles.", 4, 3],
    ...
    ["You meet a nice group of Indians, they help you along 5 tiles.", 0.4, 5],
    ["You met a mean group of Indians, they fought you off. Loose 5 tiles.", 0.7, -5],
    ["Uh Oh! Your wagon wheel broke, loose 2 tiles.", 0.6, -2],
    ["Run into buffalo, strike it rich with meet. Move 2 tiles.", 2, 2],
    ["Run into buffalo, they ran over your wagon. Loose 2 tiles.", 0.7, -2],
...
function moveTile(amount, playerSpot1){
  ...
  console.log("You moved "+amount+" tiles. Updated spot: "+updatedSpot);
}
